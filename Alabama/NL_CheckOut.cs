...
namespace Alabama
{
    public class NL_Checkout
    {
        ...
        private String nganluong_url = ConfigInfo.NganLuong_Url;

        private String merchant_site_code = ConfigInfo.NganLuong_SiteMachineCode;	//thay mã merchant site mà b?n dã dang ký vào dây

        private String secure_pass = ConfigInfo.NganLuong_SecurePass;	//thay mật khẩu giao tiếp giữa website c?a b?n v?i NgânLu?ng.vn mà bạn đã ký vào dây
